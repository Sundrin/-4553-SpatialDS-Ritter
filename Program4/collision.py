...
class PointQuadTree(object):
    ...
    def subdivide(self):
        ...
        mX = (l+r) / 2
        mY = (t+b) / 2
        self.northEast = PointQuadTree(Rectangle(Point(mX,t),Point(r,mY)),self.maxPoints,self.parent+1)
        self.southEast = PointQuadTree(Rectangle(Point(mX,mY),Point(r,b)),self.maxPoints,self.parent+1)
        self.southWest = PointQuadTree(Rectangle(Point(l,mY),Point(mX,b)),self.maxPoints,self.parent+1)
